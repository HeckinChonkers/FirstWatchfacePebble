...
static void main_window_load(Window *window){
  ...
  s_background_bitmap = gbitmap_create_with_resource(RESOURCE_ID_IMAGE_LIGHTNING);
  ...
  //s_quote_layer = text_layer_create(GRect(0, 20, 144, 200));
  ...
  //text_layer_set_text(s_quote_layer, "Even when I was studying mathematics, physics, and computer science, it always seemed that the problem of consciousness was about the most interesting problem out there for science to come to grips with\n-David Chalmers");
  //Create GFont
